...
THREE.MapControls.prototype = {
  ...
  updateCenter: function (timeDelta) {
    ...
    this._center.x = this._centerAccelerationValue * Math.cos(this._centerAccelerationAngle) * Math.pow(timeDelta,2) + this._centerVelocity.x * timeDelta + this._center.x;
    this._center.z = this._centerAccelerationValue * Math.sin(this._centerAccelerationAngle) * Math.pow(timeDelta,2) + this._centerVelocity.z * timeDelta + this._center.z;
    
    this._centerVelocity.x = this._centerAccelerationValue * Math.cos(this._centerAccelerationAngle) * timeDelta - this._centerVelocity.x * this._friction;
    this._centerVelocity.z = this._centerAccelerationValue * Math.sin(this._centerAccelerationAngle) * timeDelta - this._centerVelocity.z * this._friction;
